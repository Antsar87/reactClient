...
export const AppProvider = props =>{
    ...
    const createNewUserAppfn = async(userData)=>{
        ...
        try {
            ...
            const endPoint = `${process.env.REACT_APP_API_URL}/user/crear-usuario`
    ...
    const deleteNewUserAppfn = async(id)=>{
        ...
        try {
            const endPoint = `${process.env.REACT_APP_API_URL}/user/eliminar-usuario/${id}`
    ...
    const crearFolderUsuariofn=async(setUserFolder,inputUsuario)=>{
        ...
        try {
            const endPoint = `${process.env.REACT_APP_API_URL}/actas/crear-folder`
    ...
    const guardarFolderUsuariofn=async(setData, id)=>{
        ...
        try {
            const endPoint = `${process.env.REACT_APP_API_URL}/actas/guardar-archivos/${id}`
    ...
    const buscarFolderUsuariofn=async(setUserFolder,inputUsuario)=>{
        ...
        try {
            const endPoint = `${process.env.REACT_APP_API_URL}/actas/buscar-folder`
            const {data} = await axios.post(endPoint,inputUsuario,config)
            setUserFolder(data)
